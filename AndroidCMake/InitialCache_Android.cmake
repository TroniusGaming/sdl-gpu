...
#	SET(CHIPMUNK_LIBRARY "${BLURRR_SDK_PATH}/chipmunk/libs/${ANDROID_ABI}/libchipmunk.so" CACHE STRING "Chipmunk library")
	...
	SET(SDL_INCLUDE_DIR "${BLURRR_SDK_PATH}/SDL3/include" CACHE STRING "SDL include directory")
	SET(SDL_LIBRARY "${BLURRR_SDK_PATH}/SDL3/libs/${ANDROID_ABI}/libSDL2.so" CACHE STRING "SDL library")
	SET(SDL_LIBRARY_MAIN "${BLURRR_SDK_PATH}/SDL3/libs/${ANDROID_ABI}/libSDL2main.so" CACHE STRING "SDLmain library")
	
	SET(SDL2_INCLUDE_DIR "${BLURRR_SDK_PATH}/SDL3/include" CACHE STRING "SDL include directory")
	SET(SDL2_LIBRARY "${BLURRR_SDK_PATH}/SDL3/libs/${ANDROID_ABI}/libSDL2.so" CACHE STRING "SDL library")
	SET(SDL2_LIBRARY_MAIN "${BLURRR_SDK_PATH}/SDL3/libs/${ANDROID_ABI}/libSDL2main.so" CACHE STRING "SDLmain library")
